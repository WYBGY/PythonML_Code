...
class CvDNode(metaclass=TimingMeta):
    """
        self._x, self._y:数据集
        self.base, self.chaos:记录对数的底和当前不确定性
        self.criterion, self.category: 计算该Node计算信息增益的方法和所属类别
